...
export default function ProjectsSection() {
  ...
  return (
    <div className="section relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-tr from-primary-200 via-white to-accent-200 dark:from-gray-900 dark:via-background-dark dark:to-gray-800"></div>
